...
This is a simple bootloader for AT91SAM7256 processor located on the 
fpgaarcade.com replay board. 
...
Compiling the code requires open-source/freeware tools only:
 a) All of the ARM-side code is tested with Yartago (arm-none-eabi, see
 http://www.yagarto.de/). 
 b) The downloader, which runs under Windows, is tested with Mingw (install
...
2) Flash the created "bootrom.bin" file using bossa (see here: 
http://www.shumatech.com/web/products/bossa), sam-ba/jTag should work, too.
